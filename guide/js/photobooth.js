    ...
    var frames = {
      ...
      minimal: [
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 1200">',
          ...
          '<rect x="0" y="1068" width="900" height="132" fill="rgba(0,0,0,0.54)"/>',
          '<line x1="220" y1="1086" x2="680" y2="1086" stroke="white" stroke-width="0.7" opacity="0.32"/>',
          '<text x="450" y="1128" text-anchor="middle" fill="white" font-family="Georgia,serif" font-size="40" letter-spacing="8">THE NSB RETREAT</text>',
          '<text x="450" y="1163" text-anchor="middle" fill="white" font-family="Arial,sans-serif" font-size="23" letter-spacing="3" opacity="0.68">@thensbretreat</text>',
        '</svg>'
      ].join(''),
      ...
      beach: [
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 1200">',
          ...
          // Text on wave
          '<text x="450" y="1148" text-anchor="middle" fill="#1a4a6b" font-family="Georgia,serif" font-size="34" letter-spacing="5">THE NSB RETREAT</text>',
          '<text x="450" y="1181" text-anchor="middle" fill="#4a8aaa" font-family="Arial,sans-serif" font-size="22" letter-spacing="3">@thensbretreat</text>',
          // Compass — top left
      ...
      tropical: [
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 1200">',
          ...
          // Bottom text
          '<text x="450" y="1161" text-anchor="middle" fill="white" font-family="Georgia,serif" font-size="28" letter-spacing="5">THE NSB RETREAT</text>',
          '<text x="450" y="1190" text-anchor="middle" fill="white" font-family="Arial,sans-serif" font-size="20" letter-spacing="3" opacity="0.85">@thensbretreat</text>',
      ...
      polaroid: [
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 1200">',
          ...
          // Caption text
          '<text x="450" y="1106" text-anchor="middle" fill="#1a1008" font-family="Georgia,serif" font-size="46" letter-spacing="2">The NSB Retreat</text>',
          '<text x="450" y="1154" text-anchor="middle" fill="#8a6a50" font-family="Arial,sans-serif" font-size="26" letter-spacing="2">@thensbretreat</text>',
        '</svg>'
      ].join('')
    };
