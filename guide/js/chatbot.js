...
const KB = [
  ...
  { q: ['pool','swim','swimming'],
    a: 'The private pool is in the backyard. Enjoy! The pool light is controlled from the tablet in the kitchen — Equipment tab → Pool Light. See <a href="#hottub">Hot Tub</a> for full tablet instructions.' },
